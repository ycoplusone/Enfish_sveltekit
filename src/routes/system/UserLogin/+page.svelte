<script>    
    ...
    import { access_token , user_nm , user_id , user_email , is_login , permissions }     from "$lib/stores/Info.js";    // 스토어
...
<div class="container">
    ...
    <form method="post">
        ...
        <button type="submit" class="btn btn-primary" on:click="{login}">확인</button>
    </form>
</div>